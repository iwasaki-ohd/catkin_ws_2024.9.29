...
class TrackingImage:
    def __init__(self):
        ...
        # デプス画像を処理する頻度を設定 (必要に応じて調整)
        self.rate = rospy.Rate(40)  # 1 Hz, 必要に応じて調整
        ...
        self.camera_info_sub = rospy.Subscriber(
            "/cam_1/aligned_depth_to_color/camera_info",
            CameraInfo,
            self.camera_info_callback,
        )

        self.depth_image_sub = rospy.Subscriber(
            "/cam_1/aligned_depth_to_color/image_raw", Image, self.depth_image_callback
        )
