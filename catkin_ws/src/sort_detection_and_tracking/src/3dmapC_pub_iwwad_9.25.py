                ...
                if part_name == "rightShoulder" or part_name == "leftShoulder":
                    ...
                    for bb in self.bb_data.bounding_boxes:
                        if bb.xmin <= x <= bb.xmax and bb.ymin <= y <= bb.ymax:
                            ...
                            world_coordinate = map3d_coordinate[:] # コピー元を参照しない
                            world_coordinate[0][0] = map3d_coordinate[0][0]*math.cos(math.radians(109)) + map3d_coordinate[0][1]*math.sin(math.radians(109))
                            world_coordinate[0][1] = -map3d_coordinate[0][0]*math.sin(math.radians(109)) + map3d_coordinate[0][1]*math.cos(math.radians(109))
