...
struct Bbox6Array_
{
  ...
  _image_type image;
   ...
   typedef std::vector< ::detection_only::Bbox_6_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::detection_only::Bbox_6_<ContainerAllocator> >> _bboxes_type;
  _bboxes_type bboxes;
